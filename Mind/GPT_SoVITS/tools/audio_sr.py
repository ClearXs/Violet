...
from Mind.GPT_SoVITS.tools.AP_BWE_main.models.model import APNet_BWE_Model
from Mind.GPT_SoVITS.tools.AP_BWE_main.datasets1.dataset import amp_pha_stft, amp_pha_istft
...
class AP_BWE:
    def __init__(self, device, DictToAttrRecursive, checkpoint_file=None):
        if checkpoint_file == None:
            checkpoint_file = "%s/24kto48k/g_24kto48k.zip" % (
                AP_BWE_main_dir_path)

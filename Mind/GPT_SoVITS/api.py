...
from Mind.GPT_SoVITS.TTS_infer_pack.text_segmentation_method import get_method_names as get_cut_method_names
from Mind.GPT_SoVITS.TTS_infer_pack.TTS import TTS, TTS_Config
...
parser.add_argument("-c", "--tts_config", type=str,
                    default="Mind/GPT_SoVITS/configs/tts_infer.yaml", help="tts_infer路径")

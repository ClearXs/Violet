...
from Mind.GPT_SoVITS.text import symbols as symbols_v1
from Mind.GPT_SoVITS.text import symbols2 as symbols_v2
...
def clean_text(text, language, version=None):
    ...
    if version == "v1":
        ...
        language_module_map = {"zh": "chinese2", "ja": "japanese",
                               "en": "english", "ko": "korean", "yue": "cantonese"}

...
class EmbeddingConfig(BaseModel):
    ...
    Embedding model configuration. This object specifies all the information necessary to access an embedding model to usage with Violet, except for secret keys.

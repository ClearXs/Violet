...
from violet.constants import CORE_MEMORY_BLOCK_CHAR_LIMIT
from violet.schemas.violet_base import VioletBase

# block of the LLM context


class BaseBlock(VioletBase, validate_assignment=True):
    ...
    is_template: bool = Field(
        False, description="Whether the block is a template (e.g. saved human/persona options).")

    # context window label
    label: Optional[str] = Field(
        None, description="Label of the block (e.g. 'human', 'persona') in the context window.")

    # metadata
    description: Optional[str] = Field(
        None, description="Description of the block.")
...
class Block(BaseBlock):
    ...
    organization_id: Optional[str] = Field(
        None, description="The unique identifier of the organization associated with the block.")

...
class ProceduralMemoryItemBase(VioletBase):
    """
    ...
    summary: str = Field(...,
                         description="Short descriptive text about the procedure")
...
class ProceduralMemoryItemUpdate(VioletBase):
    """Schema for updating an existing procedural memory item."""
    id: str = Field(...,
                    description="Unique ID for this procedural memory entry")

...
class OpenAIAssistant(BaseModel):
    """Represents an OpenAI assistant (equivalent to Violet preset)"""
...
class OpenAIMessage(BaseModel):
    ...
    run_id: Optional[str] = Field(
        None, description="The unique identifier of the run.")
    file_ids: Optional[List[str]] = Field(
...
class OpenAIThread(BaseModel):
    """Represents an OpenAI thread (equivalent to Violet agent)"""
    ...
    metadata: dict = Field(
        None, description="Metadata associated with the thread.")
...
class OpenAIRun(BaseModel):
    ...
    usage: Optional[OpenAIUsage] = Field(
        None, description="The usage of the run.")
...
class OpenAIRunStep(BaseModel):
    ...
    type: str = Field(..., description="The type of the run step.")
    status: str = Field(..., description="The status of the run step.")
    step_defaults: Union[OpenAIToolCallsStep,
                         OpenAIMessageCreationStep] = Field(..., description="The step defaults.")
    last_error: Optional[OpenAIError] = Field(

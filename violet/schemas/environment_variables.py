...
class EnvironmentVariableBase(OrmMetadataBase):
    ...
    organization_id: Optional[str] = Field(
        None, description="The ID of the organization this environment variable belongs to.")


class EnvironmentVariableCreateBase(VioletBase):
    key: str = Field(..., description="The name of the environment variable.")
    value: str = Field(...,
                       description="The value of the environment variable.")
    description: Optional[str] = Field(
...
class EnvironmentVariableUpdateBase(VioletBase):

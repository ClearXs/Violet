...
class FileMetadataBase(VioletBase):
...
class FileMetadata(FileMetadataBase):
    ...
    organization_id: Optional[str] = Field(
        None, description="The unique identifier of the organization associated with the document.")
    source_id: Optional[str] = Field(
        None, description="The unique identifier of the source associated with the file.")
    ...
    google_cloud_url: Optional[str] = Field(
        None, description="The Google Cloud URI for files stored in Google Cloud (e.g., Google Gemini files).")
    ...
    is_deleted: bool = Field(
        False, description="Whether this file is deleted or not.")

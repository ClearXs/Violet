...
class User(UserBase):
    ...
    organization_id: Optional[str] = Field(
        OrganizationManager.DEFAULT_ORG_ID, description="The organization id of the user")
    ...
    is_deleted: bool = Field(
        False, description="Whether this user is deleted or not.")
...
class UserUpdate(UserBase):
    ...
    timezone: Optional[str] = Field(
        None, description="The new timezone of the user.")
    organization_id: Optional[str] = Field(

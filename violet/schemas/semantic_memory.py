...
class SemanticMemoryItemBase(VioletBase):
    """
...
class SemanticMemoryItem(SemanticMemoryItemBase):
    ...
    metadata_: Dict[str, Any] = Field(
        default_factory=dict, description="Additional arbitrary metadata as a JSON object")
...
class SemanticMemoryItemUpdate(VioletBase):
    """
    ...
    source: Optional[str] = Field(
        None, description="Reference or origin of this information (e.g., book, article, movie)")

...
from violet.orm.mixins import AgentMixin, OrganizationMixin, SandboxConfigMixin
from violet.orm.sqlalchemy_base import SqlalchemyBase
from violet.schemas.environment_variables import SandboxEnvironmentVariable as PydanticSandboxEnvironmentVariable
...
class SandboxConfig(SqlalchemyBase, OrganizationMixin):
    ...
    __table_args__ = (UniqueConstraint(
        "type", "organization_id", name="uix_type_organization"),)
...
class SandboxEnvironmentVariable(SqlalchemyBase, OrganizationMixin, SandboxConfigMixin):
    ...
    __table_args__ = (UniqueConstraint(
        "key", "sandbox_config_id", name="uix_key_sandbox_config"),)
    ...
    description: Mapped[Optional[str]] = mapped_column(
        String, nullable=True, doc="An optional description of the environment variable.")
...
class AgentEnvironmentVariable(SqlalchemyBase, OrganizationMixin, AgentMixin):
    ...
    __table_args__ = (UniqueConstraint(
        "key", "agent_id", name="uix_key_agent"),)

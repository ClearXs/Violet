...
from violet.schemas.block import Human, Persona

if TYPE_CHECKING:
    from violet.orm import Organization
...
class Block(OrganizationMixin, SqlalchemyBase):
    ...
    __table_args__ = (UniqueConstraint(
        "id", "label", name="unique_block_id_label"),)
    ...
    limit: Mapped[BigInteger] = mapped_column(
        Integer, default=CORE_MEMORY_BLOCK_CHAR_LIMIT, doc="Character limit of the block.")

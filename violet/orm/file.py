...
class FileMetadata(SqlalchemyBase, OrganizationMixin):
    ...
    source_id: Mapped[Optional[str]] = mapped_column(
        String, nullable=True, doc="The unique identifier of the source associated with the file.")
    ...
    source_url: Mapped[Optional[str]] = mapped_column(
        String, nullable=True, doc="The URL of the remote file (for files not stored locally).")
    google_cloud_url: Mapped[Optional[str]] = mapped_column(
        String, nullable=True, doc="The Google Cloud URI for files stored in Google Cloud (e.g., Google Gemini files).")

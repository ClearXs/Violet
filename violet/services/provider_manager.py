...
from violet.orm.provider import Provider as ProviderModel
...
class ProviderManager:
    ...
    def upsert_provider(self, name: str, api_key: str, organization_id: str, actor: PydanticUser) -> PydanticProvider:
        ...
        with self.session_maker() as session:
            ...
            existing_providers = [p for p in self.list_providers(
    ...
    def get_anthropic_override_provider_id(self) -> Optional[str]:
        ...
        anthropic_provider = [
            provider for provider in self.list_providers() if provider.name == "anthropic"]
    ...
    def get_gemini_override_provider_id(self) -> Optional[str]:
        ...
        gemini_provider = [
            provider for provider in self.list_providers() if provider.name == "google_ai"]
    ...
    def get_azure_openai_override_provider_id(self) -> Optional[str]:
        ...
        azure_openai_provider = [
            provider for provider in self.list_providers() if provider.name == "azure_openai"]

...
class G2PWOnnxConverter:
    def __init__(
        ...
        self.config = load_config(config_path=os.path.join(
            uncompress_path, "config.py"), use_default=True)
        ...
        polyphonic_chars_path = os.path.join(
            uncompress_path, "POLYPHONIC_CHARS.txt")
        monophonic_chars_path = os.path.join(
            uncompress_path, "MONOPHONIC_CHARS.txt")

...
# Add the violet directory to the Python path
...
def extract_schema_ddl():
    ...
    for table in metadata.sorted_tables:
        ...
        create_table_ddl = str(CreateTable(
...
def get_basic_schema():
    ...
    return """
-- Basic PGlite Schema for Violet
...
CREATE TABLE agents (
    ...
    memory TEXT,
    tools TEXT,
    agent_type VARCHAR DEFAULT 'violet_agent',
    llm_config TEXT,

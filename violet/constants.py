...
MIRIX_CORE_TOOL_MODULE_NAME = "violet.functions.function_sets.base"
MIRIX_MEMORY_TOOL_MODULE_NAME = "violet.functions.function_sets.memory_tools"
...
# embeddings
# maximum supported embeding size - do NOT change or else DBs will need to be reset
...
BASE_TOOLS = ["send_message", "send_intermediate_message",
              "conversation_search", 'search_in_memory', 'list_memory_within_timerange']
# Base memory tools CAN be edited, and are added by default by the server
CORE_MEMORY_TOOLS = ["core_memory_append", "core_memory_rewrite"]
EPISODIC_MEMORY_TOOLS = ['episodic_memory_insert', 'episodic_memory_merge',
                         'episodic_memory_replace', 'check_episodic_memory']
...
SEMANTIC_MEMORY_TOOLS = ['semantic_memory_insert',
                         'semantic_memory_update', 'check_semantic_memory']
...
UNIVERSAL_MEMORY_TOOLS = ['search_in_memory',
                          "finish_memory_update", 'list_memory_within_timerange']
ALL_TOOLS = list(set(BASE_TOOLS + CORE_MEMORY_TOOLS + EPISODIC_MEMORY_TOOLS + PROCEDURAL_MEMORY_TOOLS + RESOURCE_MEMORY_TOOLS +
                 KNOWLEDGE_VAULT_TOOLS + SEMANTIC_MEMORY_TOOLS + META_MEMORY_TOOLS + UNIVERSAL_MEMORY_TOOLS + CHAT_AGENT_TOOLS))
...
LOGGER_LOG_LEVELS = {"CRITICAL": CRITICAL, "ERROR": ERROR, "WARN": WARN,
...
# The error message that Violet will receive
...
RESERVED_FILENAMES = {"CON", "PRN", "AUX",
